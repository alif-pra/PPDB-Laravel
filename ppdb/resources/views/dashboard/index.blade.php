    ...
    <div class="row">
        ...
        <div class="row">
            ...
            <div class="card info-card revenue-card">
                <div class="card-body">
                <h5 class="card-title" style="font-family: Arial; color: black">Jumlah Admin</span></h5>
            ...
            <div class="card info-card sales-card">
                <div class="card-body">
                <h5 class="card-title" style="font-family: Arial; color: black">Jumlah Pendaftar PPDB</span></h5>
                <div class="d-flex align-items-center">
                    <div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
            ...
            <div class="card">
                <div class="card-body">
                  <h5 class="card-title" style="font-family: Arial; color: black">Petunjuk Pendaftaran</h5>
