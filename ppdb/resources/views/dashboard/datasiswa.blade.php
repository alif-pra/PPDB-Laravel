...
<div class="row" style="height: 500px">
    <div class="col-lg-4">
      <div class="card">
        <div class="card-body">
          ...
          <h5 class="card-title" style="font-family: Arial; color: black">Biodata Calon Peserta</h5>
          <p>Biodata Siswa</p>
    ...
    <div class="col-lg-4">
        <div class="card">
          <div class="card-body">
            <h5 class="card-title" style="font-family: Arial; color: black"> Data Orang Tua</h5>
            <p>Data Orang Tua </p>
      ...
      <div class="col-lg-4">
        <div class="card">
          <div class="card-body">
            <h5 class="card-title" style="font-family: Arial; color: black">Data Pendukung</h5>
            <p> Data Pendukung </p>
