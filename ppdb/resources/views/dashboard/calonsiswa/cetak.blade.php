...
<body>
   <div class="header">
    <table class="table1" width="100%">
        <tr>
            <td class="tengah">
                <h2 style="font-size:16px">PANITIA PENERIMAAN PESERTA DIDIK BARU</h2>
                <h1 style="font-size:30px">SMK NEGERI 1 CIMAHI</h1>
                <h3 style="font-size:16px">(Terakreditasi "A")</h3>
                <h2 style="font-size:16px">Jl. Mahar Martanegara No.48, Utama, Kec. Cimahi Selatan, Jawa Barat 40533</h2>
            </td>
        </tr>
        <tr>
            <td style="text-align: center; background-color:rgb(0, 128, 128); padding:5px 0;">
                <span style="color: white; font-size:12px">Sekretariat: Kota Cimahi, Jawa Barat 40533 Telp.: (022) 6629683 Email: info@smkn1-cmi.sch.id</span>
            </td>
        </tr>
    </table>
   </div>
    <div >
        ...
        <table class="isi2">
            @foreach ( $data as $k)
            <tr style="font-family: Arial; line-height:10px">
