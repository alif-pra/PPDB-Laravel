...
<div class="card">
    <div class="card-body">
    <br>
      <h1> <center><strong style="font-family:Arial">Info Sekolah</strong></center></h1>
    <br>
    @if($cek < 1)
      <form action="{{  url('infosekolah/'.\Auth::user()->id) }}" method="post">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <textarea class="form-control summernote" style="height: 100px" name="visi" id="visi" required placeholder=" Sekolah"></textarea>
            </div>
        </div>
        <div class="row mb-3">
            <label for="misi" class="col-sm-2 col-form-label">Misi Sekolah</label>
            <div class="col-sm-10">
                <textarea class="form-control" style="height: 100px" name="misi" id="misi" required placeholder="Masukkan Misi Sekolah (setiap poin dipisahkan dengan baris baru)"></textarea>
            </div>
        </div>
        <div class="row mb-3">
      ...
      <form action="{{  url('infosekolah/'.\Auth::user()->id) }}" method="post">
        ...
        <div class="row mb-3">
            <label for="visi" class="col-sm-2 col-form-label">Visi Sekolah</label>
            <div class="col-sm-10">
                <textarea class="form-control summernote" style="height: 100px"name="visi" id="visi" required placeholder=" Sekolah">{{ $dt->visi }}</textarea>
            </div>
        </div>
        <div class="row mb-3">
            <label for="misi" class="col-sm-2 col-form-label">Misi Sekolah</label>
